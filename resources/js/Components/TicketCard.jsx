    ...
    return (
        <>
                ...
                <div className="grid col-span-2 ">
                    <div className='grid grid-cols-3 items-center '>
                        ...
                        <div className='grid grid-rows-2 col-span-2'>
                                <p className='grid '>{props.departure} - {props.arrival}</p>
                                <p className='grid  text-slate-500 text-sm'>{props.airline}</p>
                        </div>
                    </div>
                </div>
                <div className="grid ">
            ...
            <div className='grid grid-cols-3 w-[45%] text-slate-700 mb-2'>
                <div className='grid text-sm hover:txt-blue-color cursor-pointer'>Flights Detail</div>
                <div className='grid text-sm hover:txt-blue-color cursor-pointer'>Fare & Benefits</div>
            </div>
