            ...
            <div className='grid grid-rows-2 grid-cols-3 gap-10'>
                ...
                <div className="grid">
                    <div className='flex gap-3'>
                        <input type="checkbox" className='rounded-md text-[#60cff4]' onClick={ handleButtonClick } />
                ...
                <div className='grid'>
                <button type="submit" className="text-white bg-[#60cff4] hover:bg-[#60cff4]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2 gap-4"
